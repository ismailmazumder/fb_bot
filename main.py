...
# /data/data/com.facebook.lite/files/PREFS_DB
...
#
# obj = requests.get("https://graph.facebook.com/v17.0/me", params=params).json()
# uid = obj["id"]
uid = "61558511067110"
# text = random.choice(
#     [
#         "Enjoying a wonderful day with family and friends! #QualityTime #Blessed",
#         "o meri jan"
#     ]
# )
question = "make a facebook post about tranding topic of bangladesh (skip politics) just give me the main text so i can post"
# take the output as text from client.py
